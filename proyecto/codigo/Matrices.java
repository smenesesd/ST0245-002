...
public class Matrices{
    ...
    float giniIzquierda = laImpurezaDeLosDatosDeUnaMatriz(matrizLaVariableNOEsIgualAlValor);
    float giniDerecha = laImpurezaDeLosDatosDeUnaMatriz(matrizLaVariableEsIgualAlValor);
    float total = matrizLaVariableEsIgualAlValor.length + matrizLaVariableNOEsIgualAlValor.length;
    float impurezaPonderada = (giniIzquierda* matrizLaVariableNOEsIgualAlValor.length) + (giniDerecha * matrizLaVariableEsIgualAlValor.length)/total;
